...
const ProductInteraction = ({
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      ...
      <button className="ring-1 ring-gray-400 shadow-lg text-gray-500 px-4 py-2 rounded-md 
      flex items-center justify-center cursor-pointer gap-2 text-sm font-medium hover:text-cyan-50">
